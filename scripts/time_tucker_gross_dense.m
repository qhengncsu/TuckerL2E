...
for i=1:9
  for j=1:50
    ...
    times_horpcas(i,j) = (cputime-tStart)/30;
...
result = [mean(times_tals,2) mean(times_horpcas,2) mean(times_horpcac,2) mean(times_rgrad,2) mean(times_l2e,2)]
csvwrite('times_tucker_gross_dense.csv',result)